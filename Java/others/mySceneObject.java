...
public class mySceneObject extends SceneObject
{
 ...
 private Point dest;
  ...
  public BBox getBBox()
  {
    return new myBBox(new Point(position),new Point(position.getX()+8,position.getY()+8));
  }
  public ArrayList<Point> getOutline()
  {
    ArrayList<Point> a=new ArrayList<>(4);
    a.add(new Point(position));
    a.add(new Point(position.getX()+8,position.getY()));
    a.add(new Point(position.getX()+8,position.getY()+8));
    a.add(new Point(position.getX(),position.getY()+8));
    return a;
  }
